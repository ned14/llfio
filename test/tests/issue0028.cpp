...
static inline void TestIssue28()
{
  namespace llfio = LLFIO_V2_NAMESPACE;
  {
    ...
    BOOST_CHECK_EQUAL(oh.capacity(), 4200);
    BOOST_CHECK_EQUAL(oh.map().capacity(), 8192);
    ...
    BOOST_CHECK_EQUAL(ih.map().capacity(), 8192);
    ...
    BOOST_CHECK_EQUAL(oh.map().capacity(), 12288);
  ...
  }  // namespace llfio=LLFIO_V2_NAMESPACE;
  {
    ...
    auto oh = llfio::mapped_temp_file(8100, {}, llfio::mapped_file_handle::mode::read, llfio::mapped_file_handle::creation::if_needed, llfio::mapped_file_handle::caching::temporary, llfio::mapped_file_handle::flag::none).value();
    auto ih = llfio::mapped_file(8100, {}, oh.current_path().value(), llfio::mapped_file_handle::mode::write, llfio::mapped_file_handle::creation::if_needed, llfio::mapped_file_handle::caching::temporary, llfio::mapped_file_handle::flag::unlink_on_first_close).value();
