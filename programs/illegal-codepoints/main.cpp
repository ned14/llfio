...
ls testdir
 ...
 Basically he NT object manager only bans OBJECT_NAME_PATH_SEPARATOR i.e. \
 But the NTFS and FAT drivers locally ban 0-31 " * / < > ? \ |
 A filename on NTFS with a colon ':' in it appears to succeed with creation, but creates a filename truncated at the colon.
