...
//! \brief Major version for cmake and DLL version stamping
#define BOOST_AFIO_VERSION_MAJOR    2
//! \brief Minor version for cmake and DLL version stamping
#define BOOST_AFIO_VERSION_MINOR    0
//! \brief Patch version for cmake and DLL version stamping
#define BOOST_AFIO_VERSION_PATCH    0
//! \brief Revision version for cmake and DLL version stamping
#define BOOST_AFIO_VERSION_REVISION 0

//! \brief Defined between stable releases of AFIO. It means the inline namespace
//! will be permuted per-commit to ensure ABI uniqueness.
